...
public class FirstPersonController : MonoBehaviour
{
    ...
    #region NotesPopup
    public KeyCode notesKey = KeyCode.N;
    #endregion
    ...
    {
        // #region Notes
        // if (ControlFreak2.CF2Input.GetKeyDown(notesKey))
        // {
        //     if (!UIHandler.Instance.gamePanel.notesPopup.gameObject.activeSelf)
        //     {
        //         GetComponent<Interactions>().DisableCharacter();
        //     }
        //     AudioManager.instance.PlaySound("Open Notes");
        //     // Toggle Notes
        //     UIHandler.Instance.gamePanel.notesPopup.gameObject.SetActive(
        //         !UIHandler.Instance.gamePanel.notesPopup.gameObject.activeSelf
        //     );
        // }
        // #endregion
        ...
        {
            UIHandler.Instance.pausePanel.gameObject.SetActive(true);
        }
        #endregion
